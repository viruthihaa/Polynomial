...
public class Polynomial {
	...
	public static Node add(Node poly1, Node poly2) {
		Node ret = new Node(5, 8, null);  Node ptr1 = poly1; Node ptr2 = poly2; Node ptr = ret;
	...
	public static Node multiply(Node poly1, Node poly2) {
		Node ret = new Node(0,0,null); Node ptr1=poly1; Node ptr2=poly2; Node ptr=ret;
		while(ptr1!=null) {
			while(ptr2!=null) {
				
				Node term = new Node(ptr1.term.coeff*ptr2.term.coeff, ptr1.term.degree+ptr2.term.degree, null);
				ptr2=ptr2.next;
				ptr=add(ret, term);
				ptr=ptr.next;
	...
	public static float evaluate(Node poly, float x) {
		Node ptr = poly; float total = 0;
		while(ptr != null) {
			ptr.term.coeff*=Math.pow(x, ptr.term.degree);
